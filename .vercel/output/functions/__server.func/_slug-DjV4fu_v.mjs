...
import { n as projects, t as getProjectBySlug } from "./_ssr/projects-CBNklGFW.mjs";
...
import { t as useHoverScroll } from "./_ssr/use-hover-scroll-DEEOIn60.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_slug-DjV4fu_v.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function cn(...inputs) {
	return twMerge(clsx(inputs));
}
function DeviceMockup({ src, alt, video, variant = "desktop", className }) {
	const media = video ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", {
		src: video,
		"aria-label": alt,
		autoPlay: true,
		loop: true,
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							children: [
								...
								project.imageMobile && !project.video && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: project.video ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DeviceMockup, {
										src: project.image,
										video: project.video,
										alt: `${project.name} project preview`,
										variant: "desktop",
										className: "w-full"
									}) : project.imageMobile && viewMode === "mobile" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
