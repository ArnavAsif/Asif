      ...
      <header className="sticky top-0 z-50 border-b-2 border-foreground bg-background/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <nav className="hidden items-center gap-6 text-base font-extrabold md:flex">
            ...
            <Link to="/" hash="skills" className="transition-colors duration-300 hover:text-accent">
              Skills
            </Link>
            <Link to="/" hash="about" className="transition-colors duration-300 hover:text-accent">
              About
            </Link>
            <Link
              to="/"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="grid items-start gap-8 lg:grid-cols-[1fr_1.2fr] lg:gap-12">
            ...
            <div className="relative">
              ...
              {project.imageMobile && !project.video && (
              ...
              {/* Mockup view */}
              <div key={viewMode} className="transition-all duration-500">
                {project.video ? (
                  <DeviceMockup
                    src={project.image}
                    video={project.video}
          ...
          <div className="relative overflow-hidden rounded-3xl border-2 border-foreground bg-accent p-8 text-accent-foreground pop-shadow-lg sm:p-12">
            ...
            <div className="relative text-center">
              ...
              <p className="mt-3 max-w-xl mx-auto text-base sm:text-lg">
                I can build a custom Shopify store tailored to your brand. Let's talk about your
                project.
              </p>
